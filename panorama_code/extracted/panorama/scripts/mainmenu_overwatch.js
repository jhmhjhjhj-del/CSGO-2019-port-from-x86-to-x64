...
var mainmenu_overwatch = ( function()
{
	...
	function _UpdateAllControlsFromComponent()
	{
        ...
        if ( !strErrorCode )
        {
            ...
            {
				strErrorCode = "No Overwatch case assigned (offline).";
			}
		}
		...
		var hasCase = OverwatchAPI.GetAssignedCaseDescription() !== "";
		_m_btnDownload.enabled = hasCase && ( nProgress === 0 );
		_m_btnReview.enabled = hasCase && ( nProgress === 100 );

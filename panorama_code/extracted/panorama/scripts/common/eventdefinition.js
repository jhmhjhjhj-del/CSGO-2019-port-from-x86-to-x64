...
( function() {
    ...
    $.DefineEvent( 'ForceRestartVanity', 0, '', 'Reload main menu vanity model' );
    $.DefineEvent( 'MainMenuSwitchVanity', 1, 'team', 'Switch main menu vanity team ct/t' );
    $.DefineEvent( 'MainMenu_OnGoToCharacterLoadoutPressed', 0, '', 'Open vanity context menu' );
    ...
    $.DefineEvent( 'StubProfile_Updated', 0, '', 'Offline stub profile name/avatar saved' );
    ...
    $.DefineEvent( 'ShowReadyUpPanel', 1, 'unused', 'Legacy notify when accept-match popup is initializing.' );

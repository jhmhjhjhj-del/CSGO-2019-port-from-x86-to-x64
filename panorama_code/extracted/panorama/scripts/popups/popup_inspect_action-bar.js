...
var InspectActionBar = ( function (){
	...
	var _Init = function( elPanel, itemId, funcGetSettingCallback, funcGetSettingCallbackInt, elItemModelImagePanel )
	{
		...
		elPanel.FindChildInLayoutFile( 'InspectCharBtn' ).SetHasClass( 'hidden', true );
		elPanel.FindChildInLayoutFile( 'InspectWeaponBtn' ).SetHasClass( 'hidden', true );
		var elCharControls = $.GetContextPanel().FindChildTraverse( 'InspectCharModelsControls' );
		if ( elCharControls )
			elCharControls.AddClass( 'hidden' );
	};

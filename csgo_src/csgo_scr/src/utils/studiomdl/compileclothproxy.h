...
public:
	...
	FieldIndex_t m_nClothEnableField; // cloth_enable data is in the U channel of the texture mapping data sometimes. This is used for exporting cloth from 3DSMax
	...
	static bool CopyFirstFloat( CDmeVertexData *pBindState, FieldIndex_t nField, CUtlVector< float > &attr );
	...
	public:
		...
		FieldIndex_t m_nClothEnableField;
	public:

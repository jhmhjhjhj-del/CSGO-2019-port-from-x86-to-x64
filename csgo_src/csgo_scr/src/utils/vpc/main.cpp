...
const char					*g_pOption_UndefinePreprocessorDefinitions = "$UndefinePreprocessorDefinitions";
...
#define DLLSUBDIRPATH	"."
	...
	if ( !Sys_LoadInterface( p4libdll, P4_INTERFACE_VERSION, (CSysModule**)&m_pP4Module, ( void** )&g_p4 ) )
	{
	...
	g_p4->Connect( Sys_GetFactory( (CSysModule*)m_pFilesystemModule ) );

...
private:
	...
	int m_nExclusiveShadowDepthSampler;
...
public:
	...
	int TranslateShader( uint32* code, CUtlBuffer *pBufDisassembledCode, bool *bVertexShader, uint32 options, int32 nShadowDepthSamplerMask, int32 nExclusiveShadowDepthSampler, uint32 nCentroidMask, char *debugLabel );
};

...
*/
		...
		gGL->glGetIntegerv( GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS, &fields.m_nMaxVertexTIU );
		gGL->glGetIntegerv( GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS, &fields.m_nMaxCombinedTIU );

		//fields.m_nMaxCombinedTIU = 16;
		//fields.m_nMaxVertexTIU = 16;

		fields.m_nNumVertexSamplers = ( fields.m_nMaxVertexTIU > 4 ) ? 4 : 0;
		fields.m_nFirstVertexSampler = ( fields.m_nMaxCombinedTIU <= fields.m_nMaxVertexTIU ) ? 0 : 16;
		fields.m_nTotalSamplerCount = ( fields.m_nMaxCombinedTIU <= fields.m_nMaxVertexTIU ) ? 16 : ( 16 + 4 );

...
#ifdef PANORAMA_ENABLE
	{ PANORAMAUI_ENGINE_INTERFACE_VERSION, &g_pPanoramaUIEngine },
	{ PANORAMAUI_CLIENT_INTERFACE_VERSION, &g_pPanoramaUIClient },
	{ PANORAMA_TEXT_SERVICES_INTERFACE_VERSION, &g_IUITextServices },

	{ IMEMANAGER_INTERFACE_VERSION, &g_pIMEManager },
#endif

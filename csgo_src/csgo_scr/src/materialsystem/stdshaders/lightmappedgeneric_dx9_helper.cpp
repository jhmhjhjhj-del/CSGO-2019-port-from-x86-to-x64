...
// 				else
				...
				bool hasBaseAlphaEnvmapMask = hasEnvmap && IS_FLAG_SET( MATERIAL_VAR_BASEALPHAENVMAPMASK );
				...
				#endif
				{
					...
					SET_STATIC_VERTEX_SHADER_COMBO( LIGHTING_PREVIEW, nDetailBlendMode == DETAIL_BLEND_MODE_MASK_BASE_BY_DETAIL_ALPHA ? 0 : nLightingPreviewMode );
					...
					if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
					{
						...
						SET_STATIC_PIXEL_SHADER_COMBO( LIGHTING_PREVIEW, nDetailBlendMode == DETAIL_BLEND_MODE_MASK_BASE_BY_DETAIL_ALPHA ? 0 : nLightingPreviewMode );
				...
				else // Shader model 3.0, PC only
				{
					...
					SET_STATIC_PIXEL_SHADER_COMBO( DETAIL2, hasDetailTexture2 );
					SET_STATIC_PIXEL_SHADER_COMBO( SHADER_SRGB_READ, bShaderSrgbRead );
					SET_STATIC_PIXEL_SHADER_COMBO( LIGHTING_PREVIEW, nDetailBlendMode == DETAIL_BLEND_MODE_MASK_BASE_BY_DETAIL_ALPHA ? 0 : nLightingPreviewMode );  // NOTE:There's a skip combo for lightpreviewmode==1 && detailblendmode==9
					...
					SET_STATIC_PIXEL_SHADER_COMBO( ENVMAPANISOTROPY, bEnvmapAnisotropy );
					SET_STATIC_PIXEL_SHADER_COMBO( ADDBUMPMAPS, bAddBumpMaps );
					SET_STATIC_PIXEL_SHADER_COMBO( PHONG, hasPhong && !ToolsEnabled() );

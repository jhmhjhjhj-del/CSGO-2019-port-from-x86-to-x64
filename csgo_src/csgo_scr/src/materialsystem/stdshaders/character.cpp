...
BEGIN_VS_SHADER( Character, "Help for Character Shader" )
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( FAKERIMLIGHTSCALEMINMAX, SHADER_PARAM_TYPE_VEC2, "", "" )
	...
	SHADER_INIT_PARAMS()
	{
		...
		if ( !params[FAKERIMLIGHTSCALEMINMAX]->IsDefined() )
		{
			params[FAKERIMLIGHTSCALEMINMAX]->SetVecValue( 0.01f, 0.05f );
		}
	...
	SHADER_DRAW
	{
		...
		DYNAMIC_STATE
		{
			...
			SetVertexShaderConstant( VERTEX_SHADER_SHADER_SPECIFIC_CONST_2, FAKERIMLIGHTSCALEMINMAX );

...
public:
	...
	int  GetFirstVertexSampler() const;
	bool HasSharedVertexSamplers() const;
	...
	bool SupportsNPO2Textures() const;
...
// ------------ End ----------------------------
	...
	virtual bool GetClientRenderStateBufferState( ClientRenderStateBuffer_t eBuffer, void const * &pvBufferBase, int &numBufferBytes ) OVERRIDE { pvBufferBase = NULL; numBufferBytes = 0; return false; }
...
// #ifdef PANORAMA_ENABLE_
	virtual void *GetOSVertexShader( const char* pszName, int nIndex ) { return 0; }
	virtual void *GetOSPixelShader( const char*  pszName, int nIndex ) { return 0; }
	virtual void GetShaderApiDynamicState( uint32 **ppRenderStates, SamplerStateCopy_t **, bool *srgbWrite ){}
// #endif
...
int CShaderAPIEmpty::GetFirstVertexSampler() const
{
	return 0;
}

bool CShaderAPIEmpty::HasSharedVertexSamplers() const
{
	return false;
}
...
bool CShaderAPIEmpty::SupportsNPO2Textures() const
{
	return true;
}
...
void CShaderAPIEmpty::ForceCommitScissorRect()
{
}
...
void CShaderAPIEmpty::ResetRenderState( bool bFullReset, bool bPanorama )
{
}

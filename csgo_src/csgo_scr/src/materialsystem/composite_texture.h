...
private:
	int m_nUniqueCompositeMaterialId;
	int m_nUniqueCompositeTextureId;
...
public:
	...
	virtual uint16 GetUnusedCompositeMaterialNameId();
	virtual void MarkCompositeMaterialNameIdUnused( uint16 id );
	virtual uint16 GetUnusedCompositeTextureNameId();
	virtual void MarkCompositeTextureNameIdUnused( uint16 id );
...
private:
	...
	uint16 m_nNextCompositeMaterialNameUnusedId;
	CUtlQueue< uint16 > m_CompositeMaterialNameUnusedIdFreeList;
	uint16 m_nNextCompositeTextureNameUnusedId;
	CUtlQueue< uint16 > m_CompositeTextureNameUnusedIdFreeList;
};

...
ConVar mat_texture_tracking( "mat_texture_tracking", "0" );
CUtlMap<ITexture*, int, int, CDefLess<ITexture*> > s_TextureRefList;
CUtlMap<ITexture*, int, int, CDefLess<ITexture*> > *g_pTextureRefList = &s_TextureRefList;
...
void CMaterialVar::SetTextureValueQueued( ITexture *texture )
{
	...
	if ( texture && !mat_texture_tracking.GetBool() )
	{

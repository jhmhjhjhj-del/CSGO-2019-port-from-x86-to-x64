...
public:
	...
	virtual uint16 GetUnusedCustomMaterialNameId();
	virtual void MarkCustomMaterialNameIdUnused( uint16 id );
...
private:
	...
	uint16 m_nNextCustomMaterialNameUnusedId;
	CUtlQueue< uint16 > m_CustomMaterialNameUnusedIdFreeList;
};

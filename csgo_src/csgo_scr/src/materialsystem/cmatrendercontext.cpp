...
void CMatRenderContext::DrawScreenSpaceRectangle( IMaterial *pMaterial, float flDestX, float flDestY, float flW, float flH, float flU0, float flV0, float flU1, float flV1, void *pClientRenderable )
{
	pMaterial = ((IMaterialInternal *)pMaterial)->GetRealTimeVersion();

	::DrawScreenSpaceRectangle( pMaterial, flDestX, flDestY, flW, flH, flU0, flV0, flU1, flV1, pClientRenderable );
}

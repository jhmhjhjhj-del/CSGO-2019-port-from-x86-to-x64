...
// ------------ End ----------------------------
	...
	{
		m_queue.QueueCall( m_pHardwareContext, &IMatRenderContext::ForceCommitScissorRect );
	}
...
// #endif // INCLUDE_SCALEFORM_

	DEFINE_QUEUED_CALL_1( PanoramaRenderFrame, int, IMatRenderContext, m_pHardwareContext );

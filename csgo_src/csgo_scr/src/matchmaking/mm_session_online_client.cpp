...
CMatchSessionOnlineClient::CMatchSessionOnlineClient( KeyValues *pSettings ) :
	...
	m_pSysSession( NULL )
{
	g_pMMF->DiagnosticInfoAdd( CFmtStr( "session_client(%p) created", this ) );
...
{
	g_pMMF->DiagnosticInfoAdd( CFmtStr( "session_client(%p) sys session", this ) );
...
CMatchSessionOnlineClient::CMatchSessionOnlineClient( CSysSessionHost *pSysSession, KeyValues *pExtendedSettings ) :
	...
	m_pSysSession( NULL )
{
	g_pMMF->DiagnosticInfoAdd( CFmtStr( "session_client(%p) migrating", this ) );
...
{
	g_pMMF->DiagnosticInfoAdd( CFmtStr( "session_client(%p) closed", this ) );
...
void CMatchSessionOnlineClient::Command( KeyValues *pCommand )
{
	...
	g_pMMF->DiagnosticInfoAdd( CFmtStr( "session_client(%p) command %s (%s)", this, szCommand, szRun ) );

...
{	// Interface delegation table, make sure it matches mm_extensions.cpp CMatchExtensions::OnExtensionInterfaceUpdated table
	// also for client.dll and server.dll interfaces, explicit registration is required via pIMatchExtensions->RegisterExtensionInterface
	// see cdll_client_int.cpp and gameinterface.cpp
	...
	{ GAMEUI_INTERFACE_VERSION,			(ExtFn_t) &CMatchExtensions::GetIGameUI,			false },
#ifdef _X360

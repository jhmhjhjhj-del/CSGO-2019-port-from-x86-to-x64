...
#ifdef PLATFORM_OSX
	,m_flPlayerUpdateTimestamp( 0.0f )
#endif
{
...
#ifdef PLATFORM_OSX
void PlayerFriend::SetUpdateTimestamp( float flTime )
{ 
	m_flPlayerUpdateTimestamp = flTime; 
}

float PlayerFriend::GetUpdateTimestamp()
{ 
	return m_flPlayerUpdateTimestamp; 
}
#endif

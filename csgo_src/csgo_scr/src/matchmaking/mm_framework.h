...
public:
	...
	virtual bool ApplySettings( KeyValues* keyValues ) OVERRIDE;
	...
	// Log diagnostic information for crash dump purposes
	virtual void DiagnosticInfoAdd( char const *szReportLine );

	// Get diagnostic information out of MM blackbox
	virtual char const * DiagnosticInfoGet();

...
/*! \brief Parse a string of characters.
    ...
    \return Non-zero, if all characters passed to this function are valid JSON.
*/
JSON_PARSER_DLL_API int JSON_parser_string(JSON_parser jc, const char *str, int maxchars);

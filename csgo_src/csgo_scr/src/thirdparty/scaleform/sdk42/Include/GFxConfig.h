...
// [VALVE] Keeps track and report GFx::Values still holding references to AS objects
// when the MovieImpl that owns the AS objects is about to be released
#if !defined( SF_BUILD_SHIPPING )
	#define GFX_AS_REPORT_ORPHAN_GFXVALUE
#endif

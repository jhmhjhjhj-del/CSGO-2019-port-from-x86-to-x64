...
// Dota says: [[ STORED IN DATABASE.  DO NOT CHANGE THESE VALUES.]] ( <vitaliy:2017> Not sure if true in CS:GO? )
enum ELanguage : int32
{
	...
	k_Lang_Vietnamese,
	// Don't forget to add to language.cpp:s_LanguageNames
	k_Lang_MAX
};

#define FOR_EACH_LANGUAGE( eLang )		for ( ELanguage eLang = k_Lang_First; eLang < k_Lang_MAX; eLang = ELanguage( eLang + 1 ) )

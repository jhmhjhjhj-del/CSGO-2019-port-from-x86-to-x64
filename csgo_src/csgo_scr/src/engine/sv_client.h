...
public: // IClientMessageHandlers
	...
	//virtual bool CLCMsg_HltvFixupOperatorReceiver( const CCLCMsg_HltvFixupOperatorReceiver &msg ) OVERRIDE;
...
public:
	...
	virtual EnginePVSContext_t *GetLastPVSContext()OVERRIDE;
protected:
...
private:
	...
	void	HltvQueueGameEvent( IGameEvent *event );
public:
	...
	EnginePVSContext_t		m_EnginePVSContext;

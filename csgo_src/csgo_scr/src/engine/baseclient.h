...
public: // Message Handlers
	...
	virtual bool CLCMsg_HltvFixupOperatorTick( const CCLCMsg_HltvFixupOperatorTick& msg ) { return false; }
...
public:
	...
	virtual void	StopHltvReplay( bool bNotifyClient = true ) OVERRIDE { }
...
private:
	...
	int				m_nSignonStateConfirmationCount;	// Should always be 0 or 1 unless the client is misbehaving; whether the client has confirmed a transition into this state

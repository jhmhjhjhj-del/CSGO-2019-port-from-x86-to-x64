...
SerializedEntityHandle_t SendTable_BuildDeltaProperties(	edict_t *pEdict, int nObjectID, bool bHasUncompressibleProps, const SendTable* pTable, SerializedEntityHandle_t OldProps, 
...
// copy uncompressible props from one entity onto another
...
void SendTable_PatchUncompressibleProps( const SendTable *pTable, bf_read &props, SerializedEntityHandle_t toEntity );

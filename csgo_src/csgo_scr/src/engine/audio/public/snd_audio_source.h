...
public:
	...
	void SetErrorLoading( bool value )
	{
		flags.m_bErrorLoading = value;
	}

	bool HasErrorLoading() const
	{
		return flags.m_bErrorLoading;
	}
	...
	void SetLoading(bool value) { m_bIsLoading = value; }

...
static char g_szCombinedStatusBuffer[16*1024] = {0}; // buffers below + 6KB in MM framework diag
...
static void Status_UpdateCombinedBuffer()
{
	...
	combinedStatusBuffer.Printf( "\nDiag:\n%s", g_pMatchFramework ? g_pMatchFramework->DiagnosticInfoGet() : "No match framework." );
}

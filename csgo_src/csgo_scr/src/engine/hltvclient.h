...
public:
	...
	void	SetFixupOperatorMode( bool bOn );
	bool	IsFixupOperatorMode()const {return m_bFixupOperatorMode;}
	virtual EnginePVSContext_t *GetLastPVSContext() { return NULL; }
...
protected:
	...
	virtual bool CLCMsg_HltvFixupOperatorTick( const CCLCMsg_HltvFixupOperatorTick& msg ) OVERRIDE;
public:
	CHLTVServer *m_pHLTV;

...
public: // IServerMessageHandlers
	...
	virtual bool SVCMsg_HltvReplay( const CSVCMsg_HltvReplay &msg ) OVERRIDE;
	virtual bool SVCMsg_HltvFixupOperatorStatus( const CSVCMsg_HltvFixupOperatorStatus &msg ) OVERRIDE;

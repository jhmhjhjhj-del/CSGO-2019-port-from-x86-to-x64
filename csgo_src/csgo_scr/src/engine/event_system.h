...
public:
	...
	{
		// sendtable and clientclass do not belong to this structure and do not count in the memory it occupies
		return sizeof( *this ) + g_pSerializedEntities->GetMemSize( m_Packed ) + this->filter.GetMemSize();
	}

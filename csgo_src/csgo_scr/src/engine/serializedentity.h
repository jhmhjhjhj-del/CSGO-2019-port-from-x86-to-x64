...
public:
	...
	bool HasUncompressibleProps()const { return m_bHasUncompressibleProps; }
	void SetUncompressibleProps(bool b ){ m_bHasUncompressibleProps = b; }
...
private:
	...
	uint8	*m_pFieldData;		
	bool	m_bHasUncompressibleProps;

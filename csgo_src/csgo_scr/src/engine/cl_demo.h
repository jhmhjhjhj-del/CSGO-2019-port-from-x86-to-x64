...
public:	// other public functions
	...
	void	SetStatsFileName( const char *pFileName );
	bool	OpenStatsFile();
	void	CloseStatsFile();
	void	MarkFrame( double flFrameStartTime, double flFrameStartDelta, double flFrameSwapTime, double flFrameSwapDelta, float flFPSVariability );
...
public:
	...
	FileHandle_t    m_hStatsFile;
	char 			m_statsFileName[MAX_OSPATH];

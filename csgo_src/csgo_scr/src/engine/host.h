...
// PeekMessage during long BSP/spawn so Windows does not AppHang-kill us while
// nested V_RenderVGuiOnly is suppressed (sv.IsLoading).
...
// Was 0.001 (=1000 FPS floor). With fps_max 0 / -forcenovsync, real dt can be
// << 1ms; clamping UP made host_remainder advance faster than wall clock ?
// movement / ROF / knife all felt accelerated. Allow up to ~20k FPS worth of dt.
#define MIN_FRAMETIME	0.00005
#define MAX_TOOLS_FRAMETIME	2.0
#define MIN_TOOLS_FRAMETIME	0.00005

...
protected:
	...
	struct DetailObject_t
	{
		...
		CUtlSymbol m_AssociatedMaterial;
	};
...
protected:
	...
	void	PlaceDetail( const char* pMaterialName, DetailModel_t const& model, const Vector& pt, const Vector& normal );
	...
	void	AddDetailSpriteToFace( const char* pMaterialName, const Vector &vecOrigin, const QAngle &vecAngles, DetailModel_t const& model, float flScale );

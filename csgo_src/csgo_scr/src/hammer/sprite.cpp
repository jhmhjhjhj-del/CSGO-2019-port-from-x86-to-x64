...
void CSpriteModel::DrawSprite3DForVertexShader( CRender3D *pRender, unsigned char color[3] )
{
	// this 'sprite' expects the vertex shader to do the work of orienting its geometry to face the camera,
	// instead of computing it here on the cpu.
	...
	meshBuilder.TexCoord4f( 0, texul.x, texul.y, lr.x, lr.y );
	meshBuilder.Color3ub( color[0], color[1], color[2] );
	meshBuilder.Normal3fv( m_Normal.Base() );
	meshBuilder.AdvanceVertex();

	meshBuilder.Position3f( m_Origin.x, m_Origin.y, m_Origin.z );
	meshBuilder.TexCoord4f( 0, texul.x, texlr.y, lr.x, -ul.y );
	meshBuilder.Color3ub( color[0], color[1], color[2] );
	meshBuilder.Normal3fv( m_Normal.Base() );
	meshBuilder.AdvanceVertex();

	meshBuilder.Position3f( m_Origin.x, m_Origin.y, m_Origin.z );
	meshBuilder.TexCoord4f( 0, texlr.x, texlr.y, ul.x, -ul.y );
	meshBuilder.Color3ub( color[0], color[1], color[2] );
	meshBuilder.Normal3fv( m_Normal.Base() );
	meshBuilder.AdvanceVertex();

	meshBuilder.Position3f( m_Origin.x, m_Origin.y, m_Origin.z );
	meshBuilder.TexCoord4f( 0, texlr.x, texul.y, ul.x, lr.y );
	meshBuilder.Color3ub( color[0], color[1], color[2] );
	meshBuilder.Normal3fv( m_Normal.Base() );
	meshBuilder.AdvanceVertex();

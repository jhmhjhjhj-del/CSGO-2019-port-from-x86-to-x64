...
REFERENCE_PANEL( CarouselNav )
REFERENCE_PANEL( CarouselNavButton )
...
REFERENCE_PANEL( DelayLoadPanel )
REFERENCE_PANEL_CORE( CVerticalScrollForwardingPanel, VerticalScrollForwarding )
REFERENCE_PANEL( DelayLoadList )
REFERENCE_PANEL( NumberEntry )
REFERENCE_PANEL( Countdown )
#endif

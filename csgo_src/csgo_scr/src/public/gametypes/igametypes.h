...
public:
	...
	// internal name, eg 'casual'
	virtual const char* GetCurrentModeName() = 0;
	...
	virtual const char* GetSkirmishModeForMap( const char* mapGroup, const char* mapName ) = 0;

	virtual int GetMaxPlayersForTypeAndMode( int iType, int iMode, int iSkirmish = 0 ) = 0;

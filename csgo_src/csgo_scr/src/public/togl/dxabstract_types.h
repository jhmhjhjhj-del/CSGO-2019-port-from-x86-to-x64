...
#define D3DPIXELTEXTURE_MAX_SAMPLERS 16
#define D3DVERTEXTEXTURE_MAX_SAMPLERS 4
...
typedef struct _D3DCAPS9
{
	...
	DWORD	MaxVertexTIU;
	DWORD	MaxCombinedTIU;
	DWORD	NumVertexSamplers;
	DWORD	FirstVertexSampler;
	DWORD	TotalSamplerCount;
} D3DCAPS9;

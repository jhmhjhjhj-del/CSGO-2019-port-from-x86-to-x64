...
#define GLM_MAX_PIXEL_SAMPLERS D3DPIXELTEXTURE_MAX_SAMPLERS
#define GLM_MAX_VERTEX_SAMPLERS	D3DVERTEXTEXTURE_MAX_SAMPLERS
#define GLM_MAX_TOTAL_SAMPLER_COUNT (GLM_MAX_PIXEL_SAMPLERS + GLM_MAX_VERTEX_SAMPLERS)

...
inline bool SteamDatagramServer_Init( SteamDatagramErrMsg &errMsg )
{
	...
	// CSGOHACK Hack for the version of the Steamworks SDK CSGO is using
	...
	//return SteamDatagramServer_Init_Internal( errMsg, &SteamGameServerInternal_CreateInterface, ::SteamGameServer_GetHSteamUser(), ::SteamGameServer_GetHSteamPipe() );
}

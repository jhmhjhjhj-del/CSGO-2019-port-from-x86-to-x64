...
// !FIXME! CSGO Still needs to pass around IP addresses in plaintext
// in a few cases dealing with TV forwarding
// We should try to get rid of this eventually.
struct SteamDatagramServiceNetID_Legacy
{
	...
	inline bool operator==( const SteamDatagramServiceNetID_Legacy &x ) const { return m_unIP == x.m_unIP && m_unPort == x.m_unPort; }
};
...
struct SteamDatagramRelayAuthTicket
{
	...
	/// Steam ID of the gameserver we want to talk to.  This is required.
	CSteamID m_steamIDGameserver;

	/// Steam ID of the person who was authorized.  This is required.

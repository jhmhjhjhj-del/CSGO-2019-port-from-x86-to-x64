...
inline unsigned BitStringGetEndMask( int numBits ) { return g_BitStringEndMasks[numBits % BITS_PER_INT]; }

inline int BitStringCalcNumIntsForBits( int numBits )	{ return (numBits + (BITS_PER_INT-1)) / BITS_PER_INT; }
...
protected:
	...
	unsigned	BitStringGetEndMask() const		{ return ::BitStringGetEndMask( Size() ); }
...
template <int bits> struct BitStringCountToEndMask_t { };
template <> struct BitStringCountToEndMask_t< 0> { enum { MASK = 0x00000000 }; };
template <> struct BitStringCountToEndMask_t< 1> { enum { MASK = 0xfffffffe }; };
template <> struct BitStringCountToEndMask_t< 2> { enum { MASK = 0xfffffffc }; };
template <> struct BitStringCountToEndMask_t< 3> { enum { MASK = 0xfffffff8 }; };
template <> struct BitStringCountToEndMask_t< 4> { enum { MASK = 0xfffffff0 }; };
template <> struct BitStringCountToEndMask_t< 5> { enum { MASK = 0xffffffe0 }; };
template <> struct BitStringCountToEndMask_t< 6> { enum { MASK = 0xffffffc0 }; };
template <> struct BitStringCountToEndMask_t< 7> { enum { MASK = 0xffffff80 }; };
template <> struct BitStringCountToEndMask_t< 8> { enum { MASK = 0xffffff00 }; };
template <> struct BitStringCountToEndMask_t< 9> { enum { MASK = 0xfffffe00 }; };
template <> struct BitStringCountToEndMask_t<10> { enum { MASK = 0xfffffc00 }; };
template <> struct BitStringCountToEndMask_t<11> { enum { MASK = 0xfffff800 }; };
template <> struct BitStringCountToEndMask_t<12> { enum { MASK = 0xfffff000 }; };
template <> struct BitStringCountToEndMask_t<13> { enum { MASK = 0xffffe000 }; };
template <> struct BitStringCountToEndMask_t<14> { enum { MASK = 0xffffc000 }; };
template <> struct BitStringCountToEndMask_t<15> { enum { MASK = 0xffff8000 }; };
template <> struct BitStringCountToEndMask_t<16> { enum { MASK = 0xffff0000 }; };
template <> struct BitStringCountToEndMask_t<17> { enum { MASK = 0xfffe0000 }; };
template <> struct BitStringCountToEndMask_t<18> { enum { MASK = 0xfffc0000 }; };
template <> struct BitStringCountToEndMask_t<19> { enum { MASK = 0xfff80000 }; };
template <> struct BitStringCountToEndMask_t<20> { enum { MASK = 0xfff00000 }; };
template <> struct BitStringCountToEndMask_t<21> { enum { MASK = 0xffe00000 }; };
template <> struct BitStringCountToEndMask_t<22> { enum { MASK = 0xffc00000 }; };
template <> struct BitStringCountToEndMask_t<23> { enum { MASK = 0xff800000 }; };
template <> struct BitStringCountToEndMask_t<24> { enum { MASK = 0xff000000 }; };
template <> struct BitStringCountToEndMask_t<25> { enum { MASK = 0xfe000000 }; };
template <> struct BitStringCountToEndMask_t<26> { enum { MASK = 0xfc000000 }; };
template <> struct BitStringCountToEndMask_t<27> { enum { MASK = 0xf8000000 }; };
template <> struct BitStringCountToEndMask_t<28> { enum { MASK = 0xf0000000 }; };
template <> struct BitStringCountToEndMask_t<29> { enum { MASK = 0xe0000000 }; };
template <> struct BitStringCountToEndMask_t<30> { enum { MASK = 0xc0000000 }; };
template <> struct BitStringCountToEndMask_t<31> { enum { MASK = 0x80000000 }; };
...
public: // for test code
	unsigned	BitStringGetEndMask() const		{ return static_cast<unsigned>( BitStringCountToEndMask_t<NUM_BITS % BITS_PER_INT>::MASK ); }
...
inline CVariableBitStringBase::CVariableBitStringBase(int numBits)
{
	...
	m_numInts = BitStringCalcNumIntsForBits( numBits );
	m_pInt = NULL;
	AllocInts( m_numInts );
}
...
inline bool CBitStringT<BASE_OPS>::IsAllClear(void) const
{
	...
	(const_cast<CBitStringT *>(this))->GetInts()[this->GetNumInts()-1] &= ~CBitStringT<BASE_OPS>::BitStringGetEndMask(); // external semantics of const retained
...
{
	(const_cast<CBitStringT *>(this))->GetInts()[this->GetNumInts()-1] &= ~CBitStringT<BASE_OPS>::BitStringGetEndMask(); 

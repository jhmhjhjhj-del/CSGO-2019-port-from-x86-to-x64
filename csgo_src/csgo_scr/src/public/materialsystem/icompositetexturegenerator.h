...
public:
	...
	virtual uint16 GetUnusedCompositeMaterialNameId() = 0;
	virtual void MarkCompositeMaterialNameIdUnused( uint16 id ) = 0;
	virtual uint16 GetUnusedCompositeTextureNameId() = 0;
	virtual void MarkCompositeTextureNameIdUnused( uint16 id ) = 0;
};

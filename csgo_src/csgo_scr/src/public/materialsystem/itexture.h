...
public:
	...
	// ExcludeTextureFromForceIntoHardware - default is false, ie textures are forced into hardware 
	// by CTextureManager::ForceAllTexturesIntoHardware, after team select and before entering a map.
	virtual void ExcludeTextureFromForceIntoHardware( bool bExclude ) = 0;
	virtual bool IsExcludedFromForceIntoHardware() const = 0;
};

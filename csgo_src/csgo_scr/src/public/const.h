...
#define INVALID_STEAM_TICKET "Invalid user ticket"
#define INVALID_STEAM_LOGON "No user logon"
#define INVALID_STEAM_VACBANSTATE "VAC banned from secure server"
#define INVALID_STEAM_LOGGED_IN_ELSEWHERE "This account is being used in another location"
...
// How many bits to use to encode things that care about static prop
#define MAX_STATIC_PROP_BITS		16

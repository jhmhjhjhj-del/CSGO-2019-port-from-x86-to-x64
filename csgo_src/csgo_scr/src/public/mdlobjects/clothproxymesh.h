...
public:
	...
	bool m_bClothEnableInU; // when true, cloth_enable data is in the U channel of the texture mapping data. Used for exporting cloth from 3DSMax
	bool m_bMapUsingUVs; 

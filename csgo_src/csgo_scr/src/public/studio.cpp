...
int	studiohdr_t::GetActivityListVersion( void )
{
	...
	int nVersion = activitylistversion;
	...
	for (i = 1; i < pVModel->m_group.Count(); i++)
	{
		...
		nVersion = MIN( nVersion, pStudioHdr->activitylistversion );
	}

	return nVersion;
}

void studiohdr_t::SetActivityListVersion( int nActivityListVersion ) const
{
	activitylistversion = nActivityListVersion;
	...
	for (i = 1; i < pVModel->m_group.Count(); i++)
	{
		...
		pStudioHdr->SetActivityListVersion( nActivityListVersion );
	}
}

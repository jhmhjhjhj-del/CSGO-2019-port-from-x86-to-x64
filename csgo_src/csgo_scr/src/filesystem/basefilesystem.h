...
public:
	...
	virtual bool				Truncate( FileHandle_t file );
...
protected:
	...
	virtual bool FS_truncate( FILE *fp ) = 0;
...
protected:
	...
	bool						IsFileInWritableLocation( const char *pPath ) const;
	...
	bool m_bEnableFileWriteProtection;

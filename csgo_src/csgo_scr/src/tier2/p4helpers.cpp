...
bool CP4File::Edit( void )
{
	...
	return g_p4->OpenFileForEdit( m_sFilename.String() );
}
...
bool CP4File::Add( void )
{
	...
	return g_p4->OpenFileForAdd( m_sFilename.String() );
}
...
bool CP4File::IsFileInPerforce()
{
	...
	return g_p4->IsFileInPerforce( m_sFilename.String() );
}
...
{
	if ( !m_bDummyMode && g_p4 )
		g_p4->SetOpenFileChangeList( szChangeListName );
}
